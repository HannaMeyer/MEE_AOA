...
pdf("../figures/concept_figures/DI_training.pdf",width=10,height=5.7)
...
pdf("../figures/concept_figures/DI.pdf",width=5,height=5.7)
plot(trainDat_weights[,"A"],
...
pdf("../figures/concept_figures/threshold_thoughts.pdf")
 ...
 abline(attributes(newdat_aoa)$aoa_stats$threshold_stats[6],0,col="red",lty=2)
  ...
  abline(boxplot.stats(attributes(newdat_aoa)$TrainDI$DI)$stats[5],0,col="blue")
